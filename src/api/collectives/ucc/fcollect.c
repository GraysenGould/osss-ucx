...
/**
 * @brief Helper macro to define typed fcollect implementations
 *
 ...
 */
#define UCC_FCOLLECT_TYPE_DEFINITION(_type, _typename)                      \
...
#define DEFINE_FCOLLECT_TYPES(_type, _typename)                                \
  UCC_FCOLLECT_TYPE_DEFINITION(_type, _typename)

SHMEM_STANDARD_RMA_TYPE_TABLE(DEFINE_FCOLLECT_TYPES)
#undef DEFINE_FCOLLECT_TYPES

/**
 * @brief routine to define fcollectmem implementations
 *
 */
